...
import java.util.ArrayList;
    ...
    public class ColorUtils {
        ...
        private static ArrayList<ColorName> initColorList() {
            ...
            colorList.add(new ColorName("Deep Blue", 0x00, 0x00, 0x8B));
            colorList.add(new ColorName("Deep Cyan", 0x00, 0x8B, 0x8B));
            colorList.add(new ColorName("Deep Goldenrod", 0xB8, 0x86, 0x0B));
            colorList.add(new ColorName("Deep Gray", 0xA9, 0xA9, 0xA9));
            colorList.add(new ColorName("Deep Green", 0x00, 0x64, 0x00));
            colorList.add(new ColorName("Deep Khaki", 0xBD, 0xB7, 0x6B));
            colorList.add(new ColorName("Deep Magenta", 0x8B, 0x00, 0x8B));
            colorList.add(new ColorName("Deep Olivegreen", 0x55, 0x6B, 0x2F));
            colorList.add(new ColorName("Deep Orange", 0xFF, 0x8C, 0x00));
            colorList.add(new ColorName("Deep Orchid", 0x99, 0x32, 0xCC));
            colorList.add(new ColorName("Deep Red", 0x8B, 0x00, 0x00));
            colorList.add(new ColorName("Deep Salmon", 0xE9, 0x96, 0x7A));
            colorList.add(new ColorName("Deep Sea Green", 0x8F, 0xBC, 0x8F));
            colorList.add(new ColorName("Deep Slate Blue", 0x48, 0x3D, 0x8B));
            colorList.add(new ColorName("Deep Slate Gray", 0x2F, 0x4F, 0x4F));
            colorList.add(new ColorName("Deep Turquoise", 0x00, 0xCE, 0xD1));
            colorList.add(new ColorName("Deep Violet", 0x94, 0x00, 0xD3));
            ...
            colorList.add(new ColorName("Gains boro", 0xDC, 0xDC, 0xDC));
            ...
            colorList.add(new ColorName("Pale Blue", 0xAD, 0xD8, 0xE6));
            colorList.add(new ColorName("Pale Coral", 0xF0, 0x80, 0x80));
            colorList.add(new ColorName("Pale Cyan", 0xE0, 0xFF, 0xFF));
            colorList.add(new ColorName("Pale Goldenrod", 0xFA, 0xFA, 0xD2));
            colorList.add(new ColorName("Pale Gray", 0xD3, 0xD3, 0xD3));
            colorList.add(new ColorName("Pale Green", 0x90, 0xEE, 0x90));
            colorList.add(new ColorName("Pale Pink", 0xFF, 0xB6, 0xC1));
            colorList.add(new ColorName("Pale Salmon", 0xFF, 0xA0, 0x7A));
            colorList.add(new ColorName("Pale Sea Green", 0x20, 0xB2, 0xAA));
            colorList.add(new ColorName("Pale Sky Blue", 0x87, 0xCE, 0xFA));
            colorList.add(new ColorName("Pale Slate Gray", 0x77, 0x88, 0x99));
            colorList.add(new ColorName("Pale Steel Blue", 0xB0, 0xC4, 0xDE));
            colorList.add(new ColorName("Pale Yellow", 0xFF, 0xFF, 0xE0));
            ...
            colorList.add(new ColorName("Orchid", 0xBA, 0x55, 0xD3));
            colorList.add(new ColorName("Purple", 0x93, 0x70, 0xDB));
            colorList.add(new ColorName("Sea Green", 0x3C, 0xB3, 0x71));
            colorList.add(new ColorName("Slate Blue", 0x7B, 0x68, 0xEE));
            colorList.add(new ColorName("Spring Green", 0x00, 0xFA, 0x9A));
